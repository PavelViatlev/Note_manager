...
Задание 1 - файл save_notes_to_file.py. Функция записывает список заметок в текстовый файл.
Задание 2 - файл load_notes_from_file.py. Функция читает заметки из текстового файла и возвращает их в виде списка словарей.
Задание 3 - файл 
Задание 4 - файл 
Задание 5 - файл 
